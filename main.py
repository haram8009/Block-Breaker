import pygame
import sys
from pygame.constants import KEYDOWN, KEYUP, K_LEFT, K_RIGHT, K_KP_ENTER, K_RETURN, K_SPACE, MOUSEBUTTONUP, K_a, K_d, \
    K_r, K_ESCAPE, K_s, K_w
...
def check_buttons(pos):
    ...
    if not game_end:
        if classic_button.rect.collidepoint(pos) or timer_button.rect.collidepoint(
                pos) or arcade_button.rect.collidepoint(pos):
            game_set_mode = False
